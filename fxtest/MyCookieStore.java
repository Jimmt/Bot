...
/*
 * This is a custom cookie storage for the application. This will store all the
 * cookies to the shared preferences so that it persists across application
 * restarts.
 */
